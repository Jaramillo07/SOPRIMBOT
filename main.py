...
async def webhook(request: Request):
    ...
    try:
        ...
        if 'object' in data and data['object'] == 'whatsapp_business_account':
            # Buscar el primer mensaje de la entrada
        ...
        # Si no es un mensaje de WhatsApp o no se encontró mensaje válido
...
async def health_check():
    ...
    Útil para monitoreo en CloudRun.
    """
...
# Si se ejecuta directamente (para desarrollo local)
